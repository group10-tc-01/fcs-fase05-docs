...
- Workers usam projeto executavel de worker em vez de `WebApi`, mantendo os demais projetos compartilhaveis dentro do repositorio deles.
- O `fcs-audit-logs` adiciona infraestrutura de Kafka para consumo e infraestrutura de MongoDB para persistencia dos registros de auditoria.
