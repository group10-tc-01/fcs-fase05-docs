...
O ambiente Kubernetes local padrao da fase 5 sera Kind. O `fcg-solidarity-infra` deve conter instrucoes e scripts para criar o cluster local, carregar ou apontar imagens, aplicar manifests e subir os componentes compartilhados necessarios para a demo.
